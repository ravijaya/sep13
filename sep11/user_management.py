...
parser.add_argument('-f', '--directory', metavar='directory', help='USE NO to avoid USER directory creation',
                    dest='folder')
parser.add_argument('-p', '--passwd', metavar='passwd', help='USE YES to overide default password created',
                    dest='passwd')
